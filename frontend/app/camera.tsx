...
const styles = StyleSheet.create({
  ...
  liveText: { color: '#FCA5A5', fontSize: 12, fontWeight: '700' },
  previewWrap: {
    marginHorizontal: 16,
    height: 220,
    borderRadius: 16,
  ...
  apiHint: { color: '#64748B', fontSize: 11 },
  row: { gap: 8 },
  ...
  intervalChipText: { color: '#94A3B8', fontWeight: '600' },
  ...
  statusTitle: { color: '#E6F0FF', fontWeight: '700', fontSize: 15 },
  statusMeta: { color: '#64748B', fontSize: 12 },
  statusRow: { flexDirection: 'row', justifyContent: 'space-between' },
  statusLabel: { color: '#94A3B8', fontSize: 13 },
  statusValue: { color: '#E6F0FF', fontSize: 13, fontWeight: '600' },
  messageText: { color: '#CBD5E1', fontSize: 13, lineHeight: 18, marginTop: 4 },
